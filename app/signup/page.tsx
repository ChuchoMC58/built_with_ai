...
import AuthSignup from "@/components/client/auth-signup";
...
export default function SignupPage() {
  ...
  <div className="w-full max-w-md">
      ...
      <section className="relative hidden lg:block bg-neutral-950/40 border-l border-white/10">
        {/* Fondo cuadriculado + guías punteadas */}
        <div
        ...
        <div className="relative h-full w-full flex items-center justify-center p-6">
          <div className="max-w-lg w-full">
            ...
            <h2 className="text-2xl font-semibold tracking-tight mb-2">Únete a miles de creadores de contenido</h2>
            <p className="text-sm text-white/70 leading-relaxed max-w-prose mb-6">
              Que usan nuestra plataforma para crear y compartir sus historias. Convierte ideas en videos en cuestión de segundos con IA.
            </p>

            {/* Cinta de avatares + estrellas */}
